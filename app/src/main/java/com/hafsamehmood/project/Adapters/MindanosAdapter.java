...
public class MindanosAdapter extends RecyclerView.Adapter<MindanosAdapter.ViewHolder>{
    private List<Modelofallrecipes> list_secret;
    Context context;

    public MindanosAdapter(List<Modelofallrecipes> list_secret, Context context) {
    ...
    @NonNull
    @Override
    public MindanosAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_all_foods,parent,false);
        return new MindanosAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MindanosAdapter.ViewHolder holder, int position) {
