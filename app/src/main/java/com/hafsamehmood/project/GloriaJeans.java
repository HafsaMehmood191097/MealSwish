...
import com.hafsamehmood.project.Adapters.gloriajeansAdapter;
...
public class GloriaJeans extends AppCompatActivity {
    ...
    gloriajeansAdapter adapter;
    List<Modelofallrecipes> list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gloria_jeans);
        InitiateData();
    ...
    private void InitiateRecyclerView() {
        ...
        adapter=new gloriajeansAdapter(list,GloriaJeans.this);
