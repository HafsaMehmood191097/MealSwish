...
import com.hafsamehmood.project.Adapters.MindanosAdapter;
import com.hafsamehmood.project.Models.Modelofallrecipes;

import java.util.ArrayList;
import java.util.List;

public class Mindanos extends AppCompatActivity {
    RecyclerView recyclerview;
    LinearLayoutManager layoutmanager;
    MindanosAdapter adapter;
    List<Modelofallrecipes> list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mindanos);
        InitiateData();
    ...
    private void InitiateData() {
        ...
        list.add(new Modelofallrecipes(R.drawable.ginospizza,R.drawable.star2,R.drawable.ic_baseline_shopping_cart_24,"Ginos Pizza","FRs 650","Reviews 71","_________________________________________________________________________________________________________________________________________________"));
    ...
    private void InitiateRecyclerView(){
        recyclerview=findViewById(R.id.recyclerviewMindanos);
        layoutmanager=new LinearLayoutManager(this);
        layoutmanager.setOrientation(RecyclerView.VERTICAL);
        recyclerview.setLayoutManager(layoutmanager);
        adapter=new MindanosAdapter(list,Mindanos.this);
